...
RUN echo 'JVM_OPTS="$JVM_OPTS -javaagent:'/opt/jmx-exporter/jmx_prometheus_javaagent-0.15.0.jar=7070:/opt/jmx-exporter/cassandra.yaml'"' >> /etc/cassandra/cassandra-env.sh
